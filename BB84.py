...
if __name__ == "__main__":
    ...
    filename = "4level_200bins_2s_123width"
    data = read_data(filename + ".txt")
    data = splitdata(data)
    for index, array in np.ndenumerate(data):
        np.savetxt(filename + "_" + str(index) + ".txt", array, delimiter = ",")
